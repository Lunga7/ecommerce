        ...
        <div class="span12">
            ...
            <div class="widget-content nopadding">
                ...
                <tbody>
                    ...
                    <a rel="{{ $category->id }}" rel1="delete-category" <?php /* href="{{ url('/admin/delete-category/'.$category->id) }}"*/ ?> href="javascrpt:" class="btn btn-danger btn-mini deleteRecord">Delete</a></td>
                    </tr>
                    @endforeach
