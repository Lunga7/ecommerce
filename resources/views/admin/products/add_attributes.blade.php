    ...
    <div class="container-fluid"><hr>
        ...
        <div class="span12">
            ...
            <div class="widget-content nopadding">
                ...
                action="{{ url('/admin/add-attribute/'.$productDetails->id) }}" name="add_attribute" id="add_attribute" 
                > {{ csrf_field() }}
                ...
                <div class="control-group">
                    ...
                    <label class="control-label"><strong>{{ $productDetails->artist_name }}</strong></label>
                </div>
                <div class="control-group">
        ...
        <div class="span12">
            ...
            <div class="widget-content nopadding">
                ...
                <tbody>
                    ...
                    <td class="center">
                    <a rel="{{ $attribute->id }}" rel1="delete-attribute" href="javascrpt:" class="btn btn-danger btn-mini deleteRecord">Delete</a></td>
                    </tr>
